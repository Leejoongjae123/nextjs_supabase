        ...
        <div className="w-full flex-row  my-5 justify-center items-center rounded-lg">
          ...
          <div className="flex justify-center">
            <div className="flex justify-center items-center ">
              <button
                className="flex justify-center w-[80vw] md:w-[30vw]  bg-[rgb(255,0,155)] text-white font-bold px-4 py-2  border border-transparent hover:bg-black hover:border-[rgb(255,0,155)] rounded-lg text-md"
